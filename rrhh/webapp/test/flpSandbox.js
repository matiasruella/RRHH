			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"mrrrhh-display": {
								"semanticObject": "mrrrhh",
								"action": "display",
								"description": "RRHH Application ",
								"title": "RRHH Application",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=mr.rrhh",
									"url": sap.ui.require.toUrl("mr/rrhh")
								}
							}
						}
					}
